...
def main():
    ...
    print("Read raw and annotation EDF files")
    ...
    print("psg_fnames",psg_fnames)
    print("ann_fnames", ann_fnames)
    for i in range(len(psg_fnames)):
        ...
        if len(remove_idx) > 0:
            ...
            select_idx = np.setdiff1d(np.arange(len(raw_ch_df)), remove_idx)  # return in A, but not in B, A-B
        else:
        ...
        select_idx = np.intersect1d(select_idx, label_idx)    # return in A and in B
